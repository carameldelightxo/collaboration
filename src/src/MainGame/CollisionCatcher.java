...
public class CollisionCatcher {
    ...
    public void checkTile(Entity entity){
        ...
        int leftCol = leftHitBox/gp.tileSize;
        int rightCol = rightHitBox/gp.tileSize;
        int topRow = topHitBox/gp.tileSize;
        int bottomRow = bottomHitBox/gp.tileSize;
        int tile1;
        int tile2;
        switch(entity.direction){
            case "back":
                topRow = (topHitBox - entity.moveSpeed)/gp.tileSize;
                ...
                break;
            case "front":
                bottomRow = (bottomHitBox + entity.moveSpeed)/gp.tileSize;
                ...
                break;
            case "left":
                leftCol = (leftHitBox - entity.moveSpeed)/gp.tileSize;
                tile1 = gp.tileManager.tileMap[leftCol][topRow];
                ...
                break;
            case "right":
                rightCol = (rightHitBox + entity.moveSpeed)/gp.tileSize;
